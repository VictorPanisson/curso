...
class AlunoMaterio {
    ...
    function deleteById($Codigo) {
        $sql = "DELETE FROM aluno_materio WHERE Codigo = ?";
        $stm = $this->conn->prepare($sql);
    ...
    function create($data) {
        $sql = "INSERT INTO aluno_materio (Codigo_Aluno, Codigo_Materia, data_inicio, data_fim) VALUES (?, ?, ?, ?)";
...
$alunoMaterio = new AlunoMaterio($conn);
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], 'aluno_materio/cadastro')) {
